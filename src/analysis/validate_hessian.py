...
def compare_estimators(
    ...
    """
    Logs a per-layer comparison of two trace dictionaries and flags layers
    ...
    for name in shared:
        ...
        logger.info(f"{name:<28}{a:>14.4f}{b:>14.4f}{rel:>12.2%}{flag}")
    ...
    logger.info(f"{'SUM':<28}{sum_a:>14.4f}{sum_b:>14.4f}{sum_rel:>12.2%}")
...
if __name__ == "__main__":
    ...
    logger.info("PyHessian per-layer traces:")
    for k, v in py.items():
