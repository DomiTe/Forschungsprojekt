...
def run_experiment():
    ...
    # Setup Data
        ...
        def run_ptq(exp_name, qconfig_fn, method_key):
            ...
            # Setup the structure (needed for both loading and training)
    ...
    for exp_name, layers in aggregate_layer_results.items():
        ...
        # Save the averaged layer results for this experiment
    ...
    # ---------------------------------------------------------
    # REDUNDANT - Experiment 4: Fake Quantization Analysis - REDUNDANT
    # ---------------------------------------------------------
