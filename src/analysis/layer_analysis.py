...
class LayerAnalyzer:
    ...
    # REDUNDANT CODE BECAUSE OF REAL QUANTIZATION ANALYSATION BUT KEEPING IT HERE FOR DOCUMENTATION PURPOSE
    ...
    #     # Setup Fake Quantized Model (for Fidelity comparison)
