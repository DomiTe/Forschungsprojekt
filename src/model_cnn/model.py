...
class CNN(nn.Module):
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        self.conv2 = nn.Conv2d(32, 64, kernel_size=KERNEL_SIZE, stride=STRIDE, padding=1, bias=True)
        self.bn2 = nn.BatchNorm2d(64)
        self.relu2 = nn.ReLU()
        
        self.conv3 = nn.Conv2d(64, 128, kernel_size=KERNEL_SIZE, stride=STRIDE, padding=1, bias=True)
        ...
        self.fc1 = nn.Linear(256 * 2 * 2 , 1024, bias=True)
        self.relu5 = nn.ReLU()
